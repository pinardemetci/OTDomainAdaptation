...
def align(X, y, k, e, mode="connectivity", metric="correlation", XontoY=True, returnCoupling=False):
	"""
	...
	couplingM, log = entropic_gromov_wasserstein(Cx, Cy, p, q, 'square_loss', epsilon=e, log=True, verbose=True)
